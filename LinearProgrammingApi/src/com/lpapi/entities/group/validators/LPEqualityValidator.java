...
//Check if two indices are equal in value
public class LPEqualityValidator implements LPNamePrefixValidator {
  ...
  public LPEqualityValidator(int index1, int index2) {
    init(index1, index2, null);
  }

  public LPEqualityValidator(int index1, int index2, String message) {
