...
class CplexLpSolverTest {
  ...
  fun testExtractResult(testCase: String, lpVar: LPVar, cplexMock: IloCplex?,
                        variableMap: MutableMap<String, IloNumVar>, wantResult: Boolean, want: Number) {
    log.info { "Test Case: $testCase" }
    val lpModel = LPModel()
  ...
  fun testInitVars(testCase: String, varGroup: String?, lpVar: LPVar, cplexMock: IloCplex?,
                   wantSuccess: Boolean, wantVarMap: MutableMap<String, IloNumVar>) {
    log.info { "Test Case: $testCase" }
    val lpModel = LPModel()
    if (varGroup == null)
      lpModel.variables.add(lpVar)
  ...
  fun testInitConstraints(desc: String, variableMap: MutableMap<LPVar, IloNumVar>, cplexMock: IloCplex?,
                          lhs: LPExpression, operator: LPOperator, rhs: LPExpression, wantSuccess: Boolean,
  ...
  fun testInitObjective(desc: String, variableMap: MutableMap<LPVar, IloNumVar>, cplexMock: IloCplex?,
                        objectiveExpr: LPExpression, objectiveType: LPObjectiveType, wantSuccess: Boolean,
