...
class GlpkLpSolverTest {
  ...
  private fun setModel(solver: GlpkLpSolver, model: GLPKProblem) =
      setParameter(solver, "glpkModel", model)

  private fun setCfg(solver: GlpkLpSolver, cfg: GlpIocp) = setParameter(solver, "cfg", cfg)
  ...
  private fun argsForInitVars() = Stream.of(
      ...
      Arguments.of(
          ...
          mock<GLPKProblem> {
            ...
            on {
              setColBounds(1,
                  GLPKBoundType.DOUBLE_BOUNDED, 0.0, 1.0
              )
            }.thenThrow(RuntimeException())
          },
  ...
  fun testGetSolutionStatus(desc: String, glpkStatus: GLPKMipStatus, wantStatus: LPSolutionStatus) {
    log.info { "Test Case: $desc" }
    val model = LPModel()
    val solver = GlpkLpSolver(model)
  ...
  private fun argsForSolve() = Stream.of(
      Arguments.of(
          ...
          fun(model: LPModel): GlpkLpSolver = GlpkLpSolver(model).apply {
            ...
            setCfg(this, mockCfg)
            this.initModel()
            setModel(this, mock<GLPKProblem> {
  ...
  private fun argsForInitConstraints() = Stream.of(
      ...
      Arguments.of(
          ...
          mock<GLPKProblem> {
            ...
            on {
              setRowBounds(1, GLPKBoundType.UPPER_BOUNDED,
                  0.0, 10.0
              )
            }.thenThrow(RuntimeException())
          },
