...
class GlpkLpSolverTest {
  ...
  private fun<T> getParameter(solver: GlpkLpSolver, fieldName: String) : T? {
    solver.javaClass.getDeclaredField(fieldName).let { field ->
      field.isAccessible = true
      return field.get(solver).let { it as T }
    }
  }

  private fun getModel(solver:GlpkLpSolver) : glp_prob? = getParameter<glp_prob>(solver, "glpkModel")
  ...
  fun TestInitModel(desc: String, initMock: () -> (()-> Unit),
                    model: LPModel,
                    wantSuccess: Boolean,
                    wantModel: glp_prob?) {
  ...
  private fun argsForInitVars()= Stream.of(
      ...
      Arguments.of(
          ...
          fun(): (() -> Unit) {
            ...
            mockedStatic.`when`<glp_prob?> { GLPK.glp_create_prob() }.thenReturn(mockedModel)
            mockedStatic.`when`<Int?> { GLPK.glp_add_cols(mockedModel, 1) }.thenReturn(1)
            mockedStatic.`when`<Unit> { GLPK.glp_set_col_bnds(mockedModel, 1,
                GLPKConstants.GLP_DB, 0.0, 1.0) }.thenThrow(RuntimeException())
            return {mockedStatic.close()}
          },
      ...
      Arguments.of(
          ...
          fun(): (() -> Unit) {
            ...
            mockedStatic.`when`<glp_prob?> { GLPK.glp_create_prob() }.thenReturn(mockedModel)
            mockedStatic.`when`<Int?> { GLPK.glp_add_cols(mockedModel, 1) }.thenReturn(1)
            mockedStatic.`when`<Unit> { GLPK.glp_set_col_bnds(mockedModel, 1, GLPKConstants.GLP_FX,
                1.0, 1.0) }.thenThrow(RuntimeException())
            return {mockedStatic.close()}
          },
  ...
  fun TestInitVars(desc: String, initMock: () -> (() -> Unit),
                   lpVar: LPVar,
                   wantSuccess: Boolean,
  ...
  fun testInitObjectiveFunction(desc: String, initMock: () -> (() -> Unit),
                                model: LPModel,
  ...
  fun testSolve(desc: String, initMock: () -> (() -> Unit),
                model: LPModel,
  ...
  private fun argsForInitConstraints() = Stream.of(
      ...
      Arguments.of(
          ...
          fun(): (() -> Unit) {
            ...
            mockedStatic.`when`<glp_prob?> { GLPK.glp_create_prob() }.thenReturn(mockedModel)
            mockedStatic.`when`<Int?> { GLPK.glp_add_rows(mockedModel, 1) }.thenReturn(1)
            mockedStatic.`when`<Int?> { GLPK.glp_set_row_bnds(mockedModel, 1, GLPKConstants.GLP_UP,
                0.0, 10.0) }.thenThrow(RuntimeException())
            mockedStatic.`when`<SWIGTYPE_p_int?> { GLPK.new_intArray(2) }.thenReturn(mockSwigTypePInt)
            mockedStatic.`when`<SWIGTYPE_p_double?> { GLPK.new_doubleArray(2) }.thenReturn(mockSwigTypePDouble)
            return {mockedStatic.close()}
          },
      ...
      Arguments.of(
          ...
          fun(): (() -> Unit) {
            ...
            mockedStatic.`when`<glp_prob?> { GLPK.glp_create_prob() }.thenReturn(mockedModel)
            mockedStatic.`when`<Int?> { GLPK.glp_add_rows(mockedModel, 1) }.thenReturn(1)
            mockedStatic.`when`<Int?> { GLPK.glp_set_row_bnds(mockedModel, 1, GLPKConstants.GLP_LO,
                10.0, 0.0) }.thenThrow(RuntimeException())
            mockedStatic.`when`<SWIGTYPE_p_int?> { GLPK.new_intArray(2) }.thenReturn(mockSwigTypePInt)
            mockedStatic.`when`<SWIGTYPE_p_double?> { GLPK.new_doubleArray(2) }.thenReturn(mockSwigTypePDouble)
            return {mockedStatic.close()}
          },
      ...
      Arguments.of(
          ...
          fun(): (() -> Unit) {
            ...
            mockedStatic.`when`<glp_prob?> { GLPK.glp_create_prob() }.thenReturn(mockedModel)
            mockedStatic.`when`<Int?> { GLPK.glp_add_rows(mockedModel, 1) }.thenReturn(1)
            mockedStatic.`when`<Int?> { GLPK.glp_set_row_bnds(mockedModel, 1, GLPKConstants.GLP_FX,
                10.0, 10.0) }.thenThrow(RuntimeException())
            mockedStatic.`when`<SWIGTYPE_p_int?> { GLPK.new_intArray(2) }.thenReturn(mockSwigTypePInt)
            mockedStatic.`when`<SWIGTYPE_p_double?> { GLPK.new_doubleArray(2) }.thenReturn(mockSwigTypePDouble)
            return {mockedStatic.close()}
          },
      ...
      Arguments.of(
          ...
          fun(): (() -> Unit) {
            ...
            mockedStatic.`when`<SWIGTYPE_p_int?> { GLPK.new_intArray(2) }.thenReturn(mockSwigTypePInt)
            mockedStatic.`when`<SWIGTYPE_p_double?> { GLPK.new_doubleArray(2) }.thenReturn(mockSwigTypePDouble)
            mockedStatic.`when`<Unit?>{GLPK.glp_set_mat_row(mockedModel, 1, 2,
                mockSwigTypePInt, mockSwigTypePDouble) }.thenThrow(RuntimeException())
            return {mockedStatic.close()}
          },
          LPModel("test").apply{
            this.variables.add(LPVar("x", LPVarType.INTEGER, 0, 10))
      ...
      Arguments.of(
          ...
          true,
          mutableMapOf<String, Int>(Pair("test-constraint", 1)),
      ),
  )

  @ParameterizedTest(name="{0}")
  @MethodSource("argsForInitConstraints")
  fun testInitConstraints(desc: String, initMock: () -> (() -> Unit),
                          model: LPModel,
                          initSolver: (LPModel) -> GlpkLpSolver,
                          wantSuccess: Boolean,
