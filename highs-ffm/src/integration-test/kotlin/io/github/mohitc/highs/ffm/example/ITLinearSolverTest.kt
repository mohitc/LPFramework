package io.github.mohitc.highs.ffm.example

import io.github.mohitc.highs.ffm.Bounds
import io.github.mohitc.highs.ffm.HIGHSModelStatus
import io.github.mohitc.highs.ffm.HIGHSObjective
import io.github.mohitc.highs.ffm.HIGHSProblem
import io.github.mohitc.highs.ffm.HIGHSStatus
import io.github.mohitc.highs.ffm.HIGHSVarType
import io.github.mohitc.highs.ffm.Result
...
class ITLinearSolverTest {
  ...
  fun testChangeObjectiveDirection() {
    HIGHSProblem().use { highsProblem ->
      HIGHSObjective.entries.forEach { v ->
    ...
    HIGHSProblem().use { highsProblem ->
      ...
      objectiveCoefficients.forEach { e ->
        ...
        assertEquals(
          HIGHSStatus.OK,
          gotStatus,
          "changeObjectiveCoefficient(${e.key}, ${e.value}) want OK got $gotStatus",
        )
      }
