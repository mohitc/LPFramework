...
/** The LP Constraint defined a generic liner programming constraint which is defined via a linear expression on the left
 * hand side (lhs), a linear expression on the right hand side, and an operator. The format of the constraint should be
 * lhs OPERATOR rhs
 */
