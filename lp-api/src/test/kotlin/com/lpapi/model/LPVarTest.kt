...
class LPVarTest : LPParameterTest<LPVar>() {
  ...
  fun testLpVarConstruction() {
    ...
    assertNotEquals(a, LPVar("x", LPVarType.DOUBLE, 0.0, 1.0),
    "Different variable types should not be equal")
    assertNotEquals(a, LPVar("x", LPVarType.BOOLEAN, 0.5, 1.0),
        "Different variable types should not be equal")
    assertNotEquals(a, LPVar("x", LPVarType.BOOLEAN, 0.0, 0.5),
        "Different variable types should not be equal")
