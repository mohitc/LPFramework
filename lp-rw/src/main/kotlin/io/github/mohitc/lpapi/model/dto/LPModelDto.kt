package io.github.mohitc.lpapi.model.dto
...
data class LPConstantDto(
  val identifier: String,
  val value: Double,
)

data class LPExpressionTermDto(
  val coefficient: Double?,
  val varName: String?,
  val constant: String?,
)

data class LPExpressionDto(
  val terms: List<LPExpressionTermDto>,
)
