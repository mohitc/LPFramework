...
class LPModelToDtoTest {
  ...
  private fun constantsToDto() = Stream.of(
    Arguments.of(
      "Constant without supplied value defaults to 0", "test-group", LPConstant("c"),
      LPConstantDto("c", 0.0)
    ),
    Arguments.of(
      "Constant without supplied value is reflected in DTO", "test-group",
  ...
  private fun constraintsToDto() = Stream.of(
    Arguments.of(
      ...
      LPConstraintDto(
        identifier = "test", operator = LPOperator.GREATER_EQUAL,
        lhs = LPExpressionDto(
          terms = listOf(
    ...
    Arguments.of(
      ...
      LPConstraintDto(
        identifier = "test", operator = LPOperator.EQUAL,
        lhs = LPExpressionDto(
          terms = listOf(
