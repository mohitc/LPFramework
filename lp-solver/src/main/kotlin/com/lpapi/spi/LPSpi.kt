 ...
 * a solver from the classpath. If a solver with the LpSpi is provided in the classpath, the Solver singleton can be used
 * to generate an instance of the solver without specifying the type of the solver explicitly.
  */
interface LPSpi<T> {
